...
def main():
	...
	x_dec = Conv1D(1, 4, activation='relu', padding='valid')(x_dec)
	x_dec = UpSampling1D(2)(x_dec)
	x_dec = Conv1D(2, 5, activation='relu', padding='valid')(x_dec)
	x_dec = UpSampling1D(2)(x_dec)
	x_dec = Conv1D(2, 5, activation='relu', padding='valid')(x_dec)
	x_dec = UpSampling1D(2)(x_dec)
