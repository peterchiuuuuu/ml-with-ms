...
def main():
	...
	#y_test = QM9_properties['lumo'][10000:10500]
	...
	his_data.to_csv('ep100_gap_valid_hist.csv')
	                #callbacks=callbacks_list) 
	total_model.save("ep100_gap_valid_total.h5")
	encoder.save("ep100_gap_valid_encoder.h5")
	decoder.save("ep100_gap_valid_decoder.h5")
	properties.save("ep100_gap_valid_properties.h5")
